    ...
    return (
      <BaseScreen style={styles.mainView}>
        <View style={styles.wrap}>
          <DefaultTitle style={styles.title}>Responder pregunta</DefaultTitle>
          ...
          <View style={styles.inputsContainer}>
            <View style={styles.inputContainer}>
              <InverseTextInput placeholder="Título" style={styles.textInput} onChangeText={ (t) => this.setState({params:{...this.state.params, name:t }}) } value={this.state.params.name} />
            </View>
            <View style={styles.inputContainer}>
            ...
            <View style={styles.inputContainer}>
              <DefaultTextInput placeholder="Responda la pregunta..." style={styles.textInput} value={this.user.email} editable={true} multiline={true} numberOfLines={7} />
            </View>
          </View>
