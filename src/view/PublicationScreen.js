  ...
  constructor(props) {
    ...
    this.state = {
      params: {
        ...
        nit: this.user.nit ?? '',
        nit_type: this.props.route.params.type
      }
    };
    ...
    return (
      <BaseScreen style={styles.mainView}>
        <View style={styles.wrap}>
          <DefaultTitle style={styles.title}>Crear publicación</DefaultTitle>
          ...
          <View style={styles.inputsContainer}>
            <View style={styles.inputContainer}>
              <InverseTextInput placeholder="Título del requerimiento" style={styles.textInput} onChangeText={ (t) => this.setState({params:{...this.state.params, name:t }}) } value={this.state.params.name} />
            </View>
            <View style={styles.inputContainer}>
            ...
            <View style={styles.inputContainer}>
              <DefaultTextInput placeholder="Escriba lo que necesita..." style={styles.textInput} value={this.user.email} editable={true} multiline={true} numberOfLines={7} />
            </View>
          </View>
